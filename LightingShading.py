...
def draw_pyramid():
    glLightfv(GL_LIGHT0, GL_DIFFUSE, GLfloat_4(0.0, 0.0, 0.0, 1.0))
    glLightfv(GL_LIGHT0, GL_SPECULAR, GLfloat_4(1.0, 1.0, 1.0, 1.0))
    glLightfv(GL_LIGHT0, GL_POSITION, GLfloat_4(6.0, 1.0, 0.0, 1.0))
...
def create_cube():
    ...
    # Direction of light
    direction = [.3, 0.0, -5.0, 1.0]

    # Intensity of light
    intensity = [1.7, 1.7, 0.7, 1.0]

    # Intensity of ambient light
    ambient_intensity = [1.3, 0.3, 0.3, 1.0]
...
def main():
    ...
    glutCreateWindow('Iluminacion: Juan Carlos Aranda')
